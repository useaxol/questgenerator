...
- Onda nova de tracking existente: **peça o questionário da onda anterior** na etapa 2 e trabalhe sobre ele.
...
2. **Triagem**: Critério Brasil → idade → sexo → área de atuação (+ estado civil opcional) → praça (estado/cidade com
